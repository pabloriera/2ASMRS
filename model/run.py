...
from autoencoder import AutoEncoder, PCADecoder
from utils import export_decoder
...
def train(audio_path_list, target_sampling_rate=22050,
    ...
    ae = AutoEncoder(encoder_layers, decoder_layers, seed=seed)
    ...
    trainer, metrics_tracker = ae.train_model(
        loss, learning_rate, epochs, batch_size, log_path, run_name=run_name, accelerator=accelerator)
    ...
    export_decoder(ae, X,  run_name, hps, pca_latent_space )  
